...
public class FunctionLibrary {
	...
	public static void waitForElement(String LocatorType, String LocatorValue, String TestData) {
		...
		// every webelement method have 3 conditions or locators(id,name,xpath) in that
		// only one use based on required condition
	...
	public static void capturesup(String LocatorType, String LocatorValue) throws Throwable {
		String supplerNum = "";
		// equalsIgnoreCase=> equals means equal,IgnoreCase means case not
		// sensitive(capital or small anything accept)
		// if(LocatorType.equalsIgnoreCase("xpath")) means if xpath locator matching
		// with LocatorType
	...
	public static void supplierTable() throws Throwable {
		...
		// if search text box not displayed then click on "search-panel" button
		// if text box is displayed[isDisplayed()]clear text in the text box
		// here take only xpath not other because in property file we stored with xpath
		// only no other locators
		if (!driver.findElement(By.xpath("//input[@id='psearch']")).isDisplayed())
